...
public class ItemRemoveRecyclerView extends RecyclerView {
    ...
    //添加按钮状态   0：关闭 1：将要关闭 2：将要打开 3：打开
    private int mPRleteBtnState;
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    mItemLayout = viewHolder.proj_item_layout22;
                    mPosition = viewHolder.getAdapterPosition();

                    mDelete = (TextView) mItemLayout.findViewById(R.id.proj_item_delete22);
